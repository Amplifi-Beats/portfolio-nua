export const languages: Record<'en' | 'ga', { name: string; flag: string }> = {
  en: { name: 'English', flag: 'gb' },
  ga: { name: 'Gaielge', flag: 'ie' },
} as const;
  ...
  en: {
    projectsContent: {
      sampleProject: {
        ...
        imageAltText: 'Placeholder for the sample project',
    ...
    site: {
      title: "Jack's Portfolio", // need quotes to allow my ', inconsistent now :(
      description:
    ...
    homePage: {
      pageTitle: 'Home | Jack Lawlor - Musician & Creative',
      pageDescription:
        'Welcome to the portfolio of Jack, a musician, visual artist and alleged-programmer',
      heroGreeting: "Hi, I'm Jack",
      heroSubtitlePart1: 'Musician',
      heroSubtitlePart2: 'Creative',
      heroIntroduction: 'i make electronic/rap music, digital art and i code sometimes',
    ...
    blogPage: {
      pageTitle: 'My Blog',
      pageDescription:
        'Articles and thoughts on anything and everything.',
      title: 'My Blog',
      description:
        'Articles and thoughts on anything and everything.',
    ...
    homePage: {
      ...
      heroGreeting: "Dia duit, is mise Jack",
      heroSubtitlePart1: 'Ceoltóir',
